...
## Corpus Check
- Large corpus: 102 files · ~656,053 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 421 nodes · 708 edges · 27 communities (25 shown, 2 thin omitted)
...
Cohesion: 0.07
Nodes (29): AboutContent, DEFAULT_CONTENT, AboutBody(), AboutBodyProps, AboutHeadline(), AboutHeadlineProps, FlashCard(), FlashcardItem (+21 more)

### Community 2 - "Community 2"
Cohesion: 0.07
Nodes (31): metadata, PERSON_JSON_LD, getPointerZone(), PointerZone, Dot, TargetCursor(), drawStar(), HeroMouseTrail() (+23 more)

### Community 3 - "Community 3"
Cohesion: 0.11
Nodes (35): POST(), POST(), POST(), buildStatus(), GET(), POST(), GET(), requireAdmin() (+27 more)
...
## Knowledge Gaps
- **157 isolated node(s):** `nextConfig`, `name`, `version`, `private`, `node` (+152 more)
...
- **Why does `Breadcrumbs()` connect `Community 1` to `Community 10`?**
  _High betweenness centrality (0.026) - this node is a cross-community bridge._
- **Why does `useTheme()` connect `Community 2` to `Community 1`, `Community 9`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
- **Why does `requireAdmin()` connect `Community 3` to `Community 0`, `Community 11`, `Community 6`?**
